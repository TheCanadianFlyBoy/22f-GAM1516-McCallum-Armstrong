...
void AActorSpawner::BeginPlay()
{
      ...
      Timer.SetTimer(   SpawnTimer, 
                        this, 
                        &AActorSpawner::SpawnActor, 
                        SpawnDelay, 
                        true);
...
void AActorSpawner::SpawnActor()
{
	...
	//IF World is NOT EQUAL to nullptr
		...
		//DECLARE a variable called SpawnedActor of type ABall* and assign it to the return value of World->SpawnActor<type>(args..), 
		//passing in ABall as the type argument (inside <>) and in function arguments pass --> BallTemplate, SpawnTransform, SpawnParams
		...
		//CALL AddForce(..) on the physicsComponent and pass in --> direction * 1000000, NAME_None, true
                physicsComponent->AddForce(direction * 10000000, NAME_None, true);
            }
