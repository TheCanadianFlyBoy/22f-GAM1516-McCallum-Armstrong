...
AMovingActor::AMovingActor()
{
	...
	ActorSprite->SetupAttachment(RootComponent);
...
void AMovingActor::Tick(float DeltaTime)
{
	...
	//DECLARE a variable called MovementVector of type FVector and ASSIGN it to the product of the 
	//Actors Forward Vector and DistancePerTick i.e  GetActorForwardVector() * DistancePerTick
	...
	//DECLARE a variable called NewLocation of type FVector and ASSIGN it to the sum of the Actors Current Location 
	//and the MovementVector Multiplied by DeltaTime i.e  GetActorLocation() + MovementVector * DeltaTime
