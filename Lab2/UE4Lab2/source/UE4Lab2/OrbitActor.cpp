...
void AOrbitActor::Tick(float DeltaTime)
{
    ...
    // prevent number from growing indefinitely
    ...
    //DECLARE a variable called RotateValue of type FVector and assign it to the return value of  
    //Radius.RotateAngleAxis(AngleAxis, FVector(0, 1, 0))
