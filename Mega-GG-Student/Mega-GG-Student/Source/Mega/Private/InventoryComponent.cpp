...
//	{
//
//		//IF Inventory.Find(CurrentInventoryItem, Index)
//		if (Inventory.Find(CurrentInventoryItem, Index))
//		{
//			//CALL RemoveAt() on Inventory passing in Index, 1, true)
//			Inventory.RemoveAt(Index, 1, true);
//
//
//			//CALL SetActorLocation() on CurrentInventoryItem passing in GetOwner()->GetActorLocation()
//			CurrentInventoryItem->SetActorLocation(GetOwner()->GetActorLocation());
//			//CALL Enable() on CurrentInventoryItem
//			CurrentInventoryItem->Enable();
//			//CALL ResetCurrentInventory()
